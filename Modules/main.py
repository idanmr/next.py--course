...
# Fill the area inside the first set of points with a semi-transparent red
draw.polygon(first_points, fill=(255, 0, 0, 128))

# Fill the area inside the second set of points with a semi-transparent blue
draw.polygon(second_points, fill=(0, 0, 255, 128))

# Draw the lines for the first set of points in red
draw.line(first_points, fill="red", width=2)

# Draw the lines for the second set of points in blue
draw.line(second_points, fill="blue", width=2)

# Save the image to a file
background_image.save("cow_image.png")
